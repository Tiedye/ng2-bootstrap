  ...
  <thead>
    <tr>
      <th>
        ...
        <template [ngIf]="config.theme == config.themes.BS4">&lt;</template>
        <template [ngIf]="config.theme == config.themes.BS3"><i class="glyphicon glyphicon-chevron-left"></i></template>
        </button>
      </th>
      ...
      <th>
        ...
        <template [ngIf]="config.theme == config.themes.BS4">&gt;</template>
        <template [ngIf]="config.theme == config.themes.BS3"><i class="glyphicon glyphicon-chevron-right"></i></template>
        </button>
      </th>
    </tr>
    <tr>
